...
REM Detailed Deployment Script with Enhanced Error Handling
REM This script runs commands in cmd and captures errors explicitly

cls
echo ================================================================================
echo PROBABILITY DISTRIBUTION APP - DETAILED DEPLOYMENT SCRIPT
echo ================================================================================
echo.
